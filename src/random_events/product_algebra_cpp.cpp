...
bool SimpleEvent::operator==(const CPPAbstractSimpleSet &other) {
...
CPPAbstractCompositeSetPtr_t Event::make_new_empty() const {
...
CPPAbstractCompositeSetPtr_t Event::simplify() {
